  ...
  return (
    ...
    >
      ...
      <div className="flex items-center -space-x-2">
        <img src="https://i.pravatar.cc/40?img=1" alt="User 1" loading="lazy" className="w-10 h-10 rounded-full border-2 border-white" />
        <img src="https://i.pravatar.cc/40?img=2" alt="User 2" loading="lazy" className="w-10 h-10 rounded-full border-2 border-white" />
        <img src="https://i.pravatar.cc/40?img=3" alt="User 3" loading="lazy" className="w-10 h-10 rounded-full border-2 border-white" />
